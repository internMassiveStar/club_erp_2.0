    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="mt-5 mb-5 login-input" method="post" action="{{ route('today-cheque-employee') }}">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <h6><b>Pin</b></h6>
                            <input style="border: .01px solid #969393;" type="text" class="form-control" placeholder="today Cheque" name="pin" id="pin" value='' required>
                        </div>
                        
                        <input type="hidden" value="today-cheque" name="page_name">
